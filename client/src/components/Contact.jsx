...
const Contact = () => {
    ...
    return (
        <div className="mt-0 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden">
            <motion.div
            ...
            >
                ...
                <h3 className="font-black text-white lg:text-[70px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px]">
                    Contact
                </h3>
